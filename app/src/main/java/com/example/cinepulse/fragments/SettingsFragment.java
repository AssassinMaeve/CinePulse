...
import com.example.cinepulse.adapters.AvatarAdapter;
...
public class SettingsFragment extends Fragment {
                                ...
                                .addOnSuccessListener(querySnapshot -> {
                                    if (!querySnapshot.isEmpty()) {
                                        ...
                                        db.collection("users").document(newUsername).set(userData)
                                                .addOnSuccessListener(aVoid -> db.collection("users").document(currentUsername).delete()
    ...
    private void updateEmail(FirebaseUser user, String newEmail, String oldPassword) {
        ...
        user.reauthenticate(credential).addOnSuccessListener(aVoid -> user.updateEmail(newEmail)
                .addOnSuccessListener(aVoid1 -> Toast.makeText(getContext(), "Email updated", Toast.LENGTH_SHORT).show()));
    }
